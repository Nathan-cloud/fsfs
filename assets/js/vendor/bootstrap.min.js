!(function (e, t) {
  ...
  const f = {
    ...
    E = (i, n, e = !0) => {
      if (e) {
        ...
        const s = ({ target: e }) => {
          e === n &&
            ((t = !0), n.removeEventListener("transitionend", s), w(i));
        };
        ...
        c = o
          ...
          : ((n = e),
            ...
            function e(t) {
              return (
                (t.delegateTarget = n),
                e.oneOff && b.off(n, t.type, d),
                d.apply(n, [t])
              );
            });
      var n, d, u, f, p;
      (c.delegationSelector = o ? i : null),
        (c.originalHandler = r),
        (c.oneOff = h),
        (c.uidEvent = _),
        (g[_] = c),
  ...
  const b = {
      ...
      off(r, a, e, h) {
        if ("string" == typeof a && r) {
          const [t, i, s] = B(a, e, h),
            ...
            o = a.startsWith(".");
          if (void 0 !== i)
            return l && l[s] ? void q(r, l, s, i, t ? e : null) : void 0;
          o &&
      ...
      trigger(e, t, i) {
        ...
        return (
          ...
          d
            ? ((c = document.createEvent("HTMLEvents")), c.initEvent(n, r, !0))
            : (c = new CustomEvent(t, { bubbles: r, cancelable: !0 })),
          void 0 !== i &&
  ...
  class K {
    constructor(e) {
      (e = d(e)) &&
        ((this._element = e),
        F(this._element, this.constructor.DATA_KEY, this));
    }
    dispose() {
  ...
  class oe extends K {
    ...
    _addEventListeners() {
      this._config.keyboard &&
        b.on(this._element, "keydown.bs.carousel", (e) => this._keydown(e)),
        "hover" === this._config.pause &&
          (b.on(this._element, "mouseenter.bs.carousel", (e) => this.pause(e)),
    ...
    _slide(e, h) {
      ...
      if (s && s.classList.contains("active")) this._isSliding = !1;
        ...
        !this._isSliding &&
        !this._triggerSlideEvent(s, l).defaultPrevented &&
        i &&
        s
      ) {
        (this._isSliding = !0),
    ...
    static dataApiClickHandler(e) {
      ...
      if (t && t.classList.contains("carousel")) {
        const i = { ...o.getDataAttributes(t), ...o.getDataAttributes(this) },
          s = this.getAttribute("data-bs-slide-to");
        s && (i.interval = !1),
          oe.carouselInterface(t, i),
          s && oe.getInstance(t).to(s),
          e.preventDefault();
      }
    }
  }
  b.on(
    ...
    oe.dataApiClickHandler
  ),
    b.on(window, "load.bs.carousel.data-api", () => {
      var i = f.find('[data-bs-ride="carousel"]');
      for (let e = 0, t = i.length; e < t; e++)
        oe.carouselInterface(i[e], oe.getInstance(i[e]));
    }),
    e(oe);
  const re = { toggle: !0, parent: "" },
  ...
  class le extends K {
    ...
    show() {
      if (!this._isTransitioning && !this._element.classList.contains("show")) {
        ...
        if (e) {
          ...
          if (((t = f ? le.getInstance(f) : null), t && t._isTransitioning))
            return;
        }
        if (!b.trigger(this._element, "show.bs.collapse").defaultPrevented) {
          e &&
            e.forEach((e) => {
              s !== e && le.collapseInterface(e, "hide"),
                t || F(e, "bs.collapse", null);
            });
    ...
    _getConfig(e) {
      return (
        ((e = { ...re, ...e }).toggle = Boolean(e.toggle)),
        i("collapse", e, ae),
        e
      );
    }
      ...
      f.find(t).forEach((e) => {
        ...
        (i = t
          ? (null === t._parent &&
              ...
              ((t._config.parent = s.parent), (t._parent = t._getParent())),
            "toggle")
          : s),
          le.collapseInterface(e, i);
      });
    }
  ),
    e(le);
  ...
  function Te(e) {
    return (
      (me(e) ? e.ownerDocument : e.document) || window.document
    ).documentElement;
  }
  function Oe(e) {
    return "html" === fe(e)
      ? e
      : e.assignedSlot || e.parentNode || (_e(e) ? e.host : null) || Te(e);
  }
  function Ce(e) {
  ...
  function ke(e) {
    for (
      var t, i = pe(e), s = Ce(e);
      s &&
      ((t = s), 0 <= ["table", "td", "th"].indexOf(fe(t))) &&
      "static" === Ae(s).position;
    ...
    return (
      ((!s ||
        ("html" !== fe(s) &&
          ("body" !== fe(s) || "static" !== Ae(s).position))) &&
        (s ||
          (function (e) {
  ...
  var Me = {
      ...
      fn: function (e) {
        ...
        r &&
          ...
          (n = e[n]),
          (e = r - t[l] - e[s]),
          (n = Ie(n, (s = r / 2 - t[l] / 2 + (i / 2 - a / 2)), e)),
          (o.modifiersData[h] =
            (((r = {})[c] = n), (r.centerOffset = n - s), r)));
      },
      effect: function (e) {
        var t = e.state,
          e = e.options.element,
  ...
  function He(e) {
      ...
      r =
        !0 === e
          ? ((r = o.x),
            ...
            { x: Se(Se(r * l) / l) || 0, y: Se(Se(a * l) / l) || 0 })
          : "function" == typeof e
          ? e(o)
          : o,
      a = r.x,
    ...
    f &&
      ...
      (i = "clientWidth"),
      (t = ke(s)) === pe(s) &&
        "static" !== Ae((t = Te(s))).position &&
        ((c = "scrollHeight"), (i = "scrollWidth")),
      n === k && ((g = L), (e = (e - (t[c] - h.height)) * (u ? 1 : -1))),
      n === D && ((m = x), (l = (l - (t[i] - h.width)) * (u ? 1 : -1))));
    var c,
      s = Object.assign({ position: d }, f && Pe);
    return u
      ? Object.assign(
          {},
          s,
  ...
  function Qe(e, t) {
    return "viewport" === t
      ? Ye(
          ...
          { width: o, height: n, x: r + Ve(i), y: a })
        )
      : ge(t)
      ? (((o = ye((s = t))).top = o.top + s.clientTop),
      ...
      : Ye(
          ...
          (n = -i.scrollLeft + Ve(n)),
          (i = -i.scrollTop),
          "rtl" === Ae(a || r).direction &&
            (n += xe(r.clientWidth, a ? a.clientWidth : 0) - t),
  ...
  function Je(e, t) {
    var i,
      ...
      o =
        ((i = me(l) ? l : l.contextElement || Te(e.elements.popper)),
        (l = r),
        (s =
          "clippingParents" === (r = o)
            ? ((n = Xe(Oe((s = i)))),
              me(
                (h =
                  0 <= ["absolute", "fixed"].indexOf(Ae(s).position) && ge(s)
                    ? ke(s)
                    : s)
              )
                ? n.filter(function (e) {
        ...
        ((l = n.reduce(function (e, t) {
          t = Qe(i, t);
          return (
            (e.top = xe(t.top, e.top)),
            (e.right = De(t.right, e.right)),
            (e.bottom = De(t.bottom, e.bottom)),
            (e.left = xe(t.left, e.left)),
            e
          );
        }, Qe(i, r))).width = l.right - l.left),
  ...
  var et = {
    ...
    fn: function (e) {
      ...
      if (!d.modifiersData[e]._skip) {
              ...
              return e.concat(
                "auto" === ve(t)
                  ? ((i = d),
                    ...
                    (r = e.padding),
                    (a = e.flipVariations),
                    (h = void 0 === (e = e.allowedAutoPlacements) ? de : e),
                    (l = Ge(s)),
                    (e = l
                      ? a
                        ? he
        ...
        d.placement !== o &&
          ((d.modifiersData[e]._skip = !0), (d.placement = o), (d.reset = !0));
      }
    },
          ...
          t = de.reduce(function (e, t) {
            return (
              (e[t] =
                ...
                (t = i[0] || 0),
                (s = (i[1] || 0) * o),
                0 <= [D, x].indexOf(n) ? { x: s, y: t } : { x: t, y: s })),
              e
            );
            var i, s, n, o;
          }, {}),
      ...
      fn: function (h) {
        ...
        l &&
          ((g || _) &&
            ...
            (a = "start" === a ? -c[e] : -E[e]),
            (c = n.elements.arrow),
            (c = y && c ? we(c) : { width: 0, height: 0 }),
            (s = (i = n.modifiersData["arrow#persistent"]
              ? n.modifiersData["arrow#persistent"].padding
              : { top: 0, right: 0, bottom: 0, left: 0 })[s]),
            (i = i[t]),
            (t = Ie(0, E[e], c[e])),
            (c = v ? E[e] / 2 - m - t - s - o : p - t - s - o),
            (p = v ? -E[e] / 2 + m + t + i + o : a + t + i + o),
            (v = (s = n.elements.arrow && ke(n.elements.arrow))
              ? "y" === r
                ? s.clientTop || 0
                : s.clientLeft || 0
              : 0),
            (E = n.modifiersData.offset
              ? n.modifiersData.offset[n.placement][r]
              : 0),
            (e = l[r] + c - E - v),
            (m = l[r] + p - E),
            g &&
              ((a = Ie(y ? De(u, e) : u, d, y ? xe(f, m) : f)),
              (l[r] = a),
              (A[r] = a - d)),
            _ &&
              ((i = (t = l[w]) + b["x" === r ? k : D]),
              (o = t - b["x" === r ? L : x]),
              (s = Ie(y ? De(i, e) : i, t, y ? xe(o, m) : o)),
              (l[w] = s),
              (A[w] = s - t))),
          (n.modifiersData[h] = A));
      },
              ...
              if (lt(t, e)) {
                (u.rects = {
                  reference:
                    ((t = t),
                    (o = ke(e)),
                    void 0 === (d = "fixed" === u.options.strategy) && (d = !1),
                    (r = Te(o)),
                    (t = ye(t)),
                    (a = ge(o)),
                ...
                for (var i, h, s, n = 0; n < u.orderedModifiers.length; n++)
                  !0 !== u.reset
                    ? ((i = (s = u.orderedModifiers[n]).fn),
                      (h = s.options),
                      (s = s.name),
                      "function" == typeof i &&
                        (u =
  ...
  class r extends K {
      ...
      if (!p(this._element) && !this._menu.classList.contains("show")) {
        ...
        if (!b.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
          if (this._inNavbar) o.setDataAttribute(this._menu, "popper", "none");
            ...
            (this._popper = ut(e, this._menu, i)),
              s && o.setDataAttribute(this._menu, "popper", "static");
          }
          "ontouchstart" in document.documentElement &&
            !t.closest(".navbar-nav") &&
            []
              .concat(...document.body.children)
              .forEach((e) => b.on(e, "mouseover", g)),
            this._element.focus(),
    ...
    static dataApiKeydownHandler(e) {
      if (
        ...
        if (i || "Escape" !== e.key)
          if ((e.preventDefault(), e.stopPropagation(), !p(this)))
            return (
              (t = () =>
              ...
              "Escape" === e.key
                ? (t().focus(), void r.clearMenus())
                : "ArrowUp" === e.key || "ArrowDown" === e.key
                ? (i || t().click(), void r.getInstance(t())._selectMenuItem(e))
                : void ((i && "Space" !== e.key) || r.clearMenus())
            );
      }
    }
  }
  b.on(
    ...
    b.on(document, "click.bs.dropdown.data-api", r.clearMenus),
    b.on(document, "keyup.bs.dropdown.data-api", r.clearMenus),
    b.on(
      document,
    ...
    _resetElementAttributes(e, i) {
      this._applyManipulationCallback(e, (e) => {
        ...
        void 0 === t
          ...
          : (o.removeDataAttribute(e, i), (e.style[i] = t));
      });
    }
  ...
  class Ct {
    ...
    _getConfig(e) {
      return (
        ((e = { ...Tt, ...("object" == typeof e ? e : {}) }).rootElement = d(
          e.rootElement
        )),
        i("backdrop", e, Ot),
        e
  ...
  const kt = { backdrop: !0, keyboard: !0, focus: !0 },
    Lt = {
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._element.focus(),
              (this._isTransitioning = !1),
              b.trigger(this._element, "shown.bs.modal", { relatedTarget: e });
          },
          this._dialog,
          t
        );
  ...
  class It extends K {
    ...
    show(e) {
      this._isShown ||
        b.trigger(this._element, "show.bs.offcanvas", { relatedTarget: e })
          .defaultPrevented ||
        ((this._isShown = !0),
      ...
      ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
        p(this) ||
          ...
          (e = f.findOne(".offcanvas.show")) &&
            e !== t &&
            It.getInstance(e).hide(),
          It.getOrCreateInstance(t).toggle(this));
    }
  ),
    b.on(window, "load.bs.offcanvas.data-api", () =>
      f.find(".offcanvas.show").forEach((e) => It.getOrCreateInstance(e).show())
    ),
    e(It);
  const Nt = new Set([
      "background",
        ...
        a.forEach((e) => {
          ((e, t) => {
            ...
            if (t.includes(i))
              return (
                !Nt.has(i) ||
                Boolean(jt.test(e.nodeValue) || Mt.test(e.nodeValue))
              );
  ...
  class Ut extends K {
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        if (!t.defaultPrevented && s) {
          ...
          const r = this._config["container"],
            a =
              (F(n, this.constructor.DATA_KEY, this),
        ...
        return h(t)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (t = Pt(t, this._config.allowList, this._config.sanitizeFn)),
                (e.innerHTML = t))
              : (e.textContent = t));
    }
    getTitle() {
    ...
    _initializeOnDelegatedTarget(e, t) {
      ...
      return (
        (t = t || $(e.delegateTarget, i)) ||
          ((t = new this.constructor(
            e.delegateTarget,
            this._getDelegateConfig()
          )),
          F(e.delegateTarget, i, t)),
        t
      );
    }
    _getOffset() {
    ...
    _getConfig(e) {
      ...
      return (
        ...
        ((e = {
          ...
          ...t,
          ...("object" == typeof e && e ? e : {}),
        }).container = !1 === e.container ? document.body : d(e.container)),
        "number" == typeof e.delay &&
          (e.delay = { show: e.delay, hide: e.delay }),
        "number" == typeof e.title && (e.title = e.title.toString()),
        "number" == typeof e.content && (e.content = e.content.toString()),
        i("tooltip", e, this.constructor.DefaultType),
        e.sanitize && (e.template = Pt(e.template, e.allowList, e.sanitizeFn)),
        e
      );
    }
    _getDelegateConfig() {
    ...
    show() {
      if (
        ...
        b.trigger(this._element, "show.bs.tab", { relatedTarget: e })
          ...
          (t = () => {
            b.trigger(e, "hidden.bs.tab", { relatedTarget: this._element }),
              b.trigger(this._element, "shown.bs.tab", { relatedTarget: e });
          }),
  ...
  b.on(
    ...
    function (e) {
      ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
        p(this) || Zt.getOrCreateInstance(this).show();
    }
  ),
    e(Zt);
